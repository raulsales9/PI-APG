 ...
 */
final class Version20230213114632 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id_event INT NOT NULL, name VARCHAR(50) NOT NULL, place VARCHAR(50) DEFAULT NULL, end_date DATE NOT NULL, start_date DATE NOT NULL, description VARCHAR(150) DEFAULT NULL, PRIMARY KEY(id_event)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE event_user ADD CONSTRAINT FK_92589AE271F7E88B FOREIGN KEY (event_id) REFERENCES event (id_event) ON DELETE CASCADE');
